...
import Logo from '../../../../../assets/image/integration/EkartLogo.png'
    ...
    useEffect(() => {
        const fetchIntegration = async () => {
            try {
                ...
                console.error('Error fetching Ekart integration:', err)
            } finally {
                setLoading(false)
            }
        }
        ...
        <div className='couriers-int-page ekart-int-page'>
            <section className='courier-header'>
                ...
                <div className='courier-header-right'>
                    <a href="https://ekartlogistics.com/" target="_blank" rel="noopener noreferrer">
                        Need Help?
                    </a>
                </div>
            </section>
