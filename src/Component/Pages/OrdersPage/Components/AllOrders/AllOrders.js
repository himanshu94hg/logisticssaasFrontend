                                    ...
                                    <React.Fragment key={row?.id}>
                                        ...
                                        <tr className='table-row box-shadow'>
                                            ...
                                            <td className='align-middle status-box position-relative'>
                                                ...
                                                {orderStatus[row?.status] === "pickup_requested" && row?.manifest_status && <p className='text-success fw-bold position-absolute ws-nowrap' style={{ paddingInline: '10px', fontSize: 11 }}>Manifest Generated</p>}
                                            </td>
                                            <td className='align-middle'>
