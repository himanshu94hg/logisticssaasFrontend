...
const RiskGaugeOut = ({ riskLevel, percentage, width }) => {
  // Set initial values for percentage and colors
  let percent = percentage ? percentage / 100 : 0;
  let colors = [];
  ...
  return (
    <div style={{ width: '55px', textAlign: 'center' }}>
      <GaugeChart
        ...
        style={{ width: '100%', height: 'auto' }}        // arcsLength={[0.4, 0.4, 0.4]}
