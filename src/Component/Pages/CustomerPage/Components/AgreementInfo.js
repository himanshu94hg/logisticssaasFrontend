      ...
      <div className='customer-details-container'>
        <div className='customer-details-form'>
          ...
          <div className='agreement-section'>
            ...
            <p>{dynamicContent.name}</p>
            <p>{dynamicContent.place}</p>
            <p>{dynamicContent.date}</p>
          </div>
          <div className='d-flex justify-content-end mt-4 gap-3'>
            <button className='btn main-button' onClick={updateContent}>Accept and Sign Agreement</button>
            <button className='btn main-button' onClick={handlePrint}>Download PDF</button>
          </div>
