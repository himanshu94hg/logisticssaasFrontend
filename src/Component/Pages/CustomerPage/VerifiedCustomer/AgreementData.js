...
const AgreementData = ({ Name, Company, Gst, Place, Date }) => {
    return (
        <div className='verified-agreement-section'>
            <div>
                ...
                <div className='agreement-sign-section mt-5'>
                    <div>
                        <p>Authorised Signatory/Person: <span>{Name}</span></p>
                        <p>Company Name: <span>{Company}</span></p>
                        <p>Company GST: <span>{Gst}</span></p>
                    </div>
                    <div>
                        <p>Place: <span>{Place}</span></p>
                        <p>Date: <span>{moment(Date).format("YYYY-MM-DD")}</span></p>
                    </div>
                </div>
            </div>
