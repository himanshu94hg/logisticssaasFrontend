...
function TotalOrderInfo() {
  ...
  useEffect(() => {
    ...
    //       await Promise.all([
    //         axios.get('http://dev.shipease.in:8088/api/v1/totalorder/'),
    //         axios.get('http://dev.shipease.in:8088/api/v1/totalcancelorder/'),
    //         axios.get('http://dev.shipease.in:8088/api/v1/totaldeleverdorder/'),
    //         axios.get('http://dev.shipease.in:8088/api/v1/totalrtoordercount/'),
    //       ]);
