...
function CourierDelaysInfo() {
  ...
  //       ] = await Promise.all([
  //         axios.get('http://dev.shipease.in:8088/api/v1/misrouted-deley/'),
  //         axios.get('http://dev.shipease.in:8088/api/v1/lost-deley/'),
  //         axios.get('http://dev.shipease.in:8088/api/v1/damage-deley/'),
  //         axios.get('http://dev.shipease.in:8088/api/v1/destroyed-deley/'),
  //       ]);
