    ...
    <>
      <div className='box-shadow shadow-sm p10 support-page position-relative'>
        ...
        <div className='row mt-3'>
          ...
          (<div className="col-12"><AllTickets /></div>):""}
          
          {ActiveTab === 'OpenTickets'?
          (<div className="col-12"><OpenTickets /></div>):""}
          
          {ActiveTab === 'InProgressTickets'?
          (<div className="col-12"><InProgressTickets /></div>):""}
          
          {ActiveTab === 'ClosedTickets'?
          (<div className="col-12"><ClosedTickets /></div>):""}
      ...
      <div className={`backdrop ${NewTicket || FilterTickets ? 'd-block' : 'd-none'}`}></div>
    </>
  )
}
